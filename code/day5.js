...
class Day5 {
    ...
    escapeTheMaxeCounter (data) {
        ...
        console.log(`took ${steps} steps to exit in ${(t1-t0).toFixed(2)} ms`);
        return steps;
    }

    getResult (data) {
        console.log('starting');
        data = this.createArrayFromString(data);
        this.escapeTheMaxeCounter(data);
        return data;
    }
}

new Day5().getResult(data);